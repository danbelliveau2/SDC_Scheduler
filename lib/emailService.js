...
// _sendOnce is exported so other senders can reuse the notification_log
// dedupe rather than reimplementing it. lib/serviceNotify.js (Service Work
// Order delivery + day-before reminders) relies on it for the "prevent
// duplicate reminder notifications" requirement.
module.exports = { ENABLED, sendMentionEmail, sendDigest, sendAlert, _sendOnce };
